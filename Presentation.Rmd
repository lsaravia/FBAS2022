...
--
### because local heterogeneities could be averaged
...
---
## A two-state simple forest model 
...
--
.pull-left[ 
### There are two posible state changes 

]

--
.pull-right[
#### 1) Connected forest to fragmented forest
...
.center[
<img src="Figures/plot_23.svg" width="70%">
]

???
From 2.5 to 2.0 we have an additional change, we go from a connected forest
to a fragmented forest. 

---

## From connected forest 

.center[
<img src="Figures/plot_25.svg" width="70%">
]
...
.center[
<img src="Figures/plot_27.svg" width="70%">
]

---

## To non-forest (extinction)

.center[
<img src="Figures/plot_28.svg" width="70%">
]
...
.pull-left[
* Connected forest 
<img src="Figures/Percolation.png" width="90%">
]
...
.pull-right[
* Fragmented forest
<img src="Figures/PercolationUnconnected.png" width="90%">
]
...
--
### As the forest is lost 

--
### the state change from connected to fragmented 

--
### Reachable habitat for species is now less than the habitat available.

--
### Is an abrupt change 

--
### How to detect if this change is about to happen?
...
<img src="Figures/MaxPatchLambda3-1.5.gif" width="80%">
...
### We use remote sensing data (MODIS Vegetation Continuous Fields) 
...
---
## Largest and second largest patch dynamics

.center[
<img src="Figures/southasia_SEAS_1_30_perc_threshold_in_MOD44B_Top_2_gmap.gif" width="70%">
]
...
--
## This framework could be applied to forest 

--
### And other vegetations kinds 
...
[Leonardo Saravia - lsaravia@conicet.gov.ar](mailto:lsaravia@conicet.gov.ar)

[Iara Rodriguez](https://www.researchgate.net/profile/Iara-Rodriguez-2)

[Nicolas Velazco](https://www.researchgate.net/profile/Victor-Velazco)

[Tomas Marina](https://www.researchgate.net/profile/Tomas-Marina)

[Georgina Cordone](https://www.researchgate.net/profile/Georgina-Cordone)

[Santiago Doyle](https://www.researchgate.net/profile/Santiago-Doyle)

[Vanesa Salinas](https://www.researchgate.net/profile/Vanesa-Salinas-2)

[Fernando Momo](https://www.researchgate.net/profile/Fernando-Momo)
]
